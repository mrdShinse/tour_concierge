...
RSpec.describe Livefans::EventsList::Crawlable do
  ...
  describe '#parse_events_list' do
    context '831 pages' do
      ...
      it { is_expected.to include(name: '10-FEET "Fin" TOUR 2017-2018', import: "#{livefans_root}/events/854904", artist_id: 25) }
      it { is_expected.to include(name: '10-FEET "Fin" TOUR 2017-2018', import: "#{livefans_root}/events/854872", artist_id: 25) }
    end
